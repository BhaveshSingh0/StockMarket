...
public class SendMail {
    ...
    public int send( String emailAddress , String firstName , String lastName){
        ...
        String message = "Thank you "+firstName+" "+lastName+" , Registering to the Stock market , your OTP is "+n ;
		 try {
